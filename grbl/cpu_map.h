...
#define cpu_map_h
  ...
  */
  ...
  #define LIMIT_PORT_1 D
  #define LIMIT_PORT_2 J
  #define LIMIT_BIT_0 0 // X Limit Max - Pin D2
  #define LIMIT_BIT_1 2 // Z Limit Max - Pin D15
  #define LIMIT_BIT_2 1 // null
  ...
  #define HZ_LIMIT_BIT     2 // MEGA2560 Digital Pin 11
  ...
  #define HLIMIT_MASK ((1<<HX_LIMIT_BIT)|(1<<HZ_LIMIT_BIT)) // All limit bits
